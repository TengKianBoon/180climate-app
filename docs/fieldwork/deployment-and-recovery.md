...
```powershell
python scripts/intake_db.py backup --db <private-runtime-db> --output <private-backup-file>
```
...
```powershell
python scripts/intake_db.py restore --backup <private-backup-file> --db <new-rehearsal-db> --confirm-replace
```
